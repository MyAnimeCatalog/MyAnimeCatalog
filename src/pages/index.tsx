...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center justify-center pb-10 bg-gradient-to-b from-[#2e026d] to-[#15162c] pt-16">
      ...
      <section id="search" className="flex min-h-screen flex-col items-center justify-start bg-gradient-to-b from-[#2e026d] to-[#15162c] pt-16">
        <form className="flex flex-col items-center justify-center w-4/5" action="" onSubmit={handleSearchSubmit}>
          <input className="flex items-center justify-center mb-10 rounded px-3 py-0.5" type="text" id="search-input" placeholder="Search" onChange={handleInputChange} />
          <div className="container flex items-center justify-center gap-12 px-20 py-6 flex-wrap md:overflow-auto">
            <Anime key={DUMMY_ANIME.title} anime={DUMMY_ANIME} />
            <Anime key={DUMMY_ANIME.title} anime={DUMMY_ANIME} />
            <Anime key={DUMMY_ANIME.title} anime={DUMMY_ANIME} />
            <Anime key={DUMMY_ANIME.title} anime={DUMMY_ANIME} />
          </div>
